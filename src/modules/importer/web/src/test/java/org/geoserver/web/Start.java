...
public class Start {
    ...
    public static void main(String[] args) {
        ...
        if(System.getProperty("GEOSERVER_DATA_DIR") == null && System.getenv("GEOSERVER_DATA_DIR") == null) {
        	throw new RuntimeException("You have to specify -DGEOSERVER_DATA_DIR=/path/to/your/data/dir among the JVM startup params");
        }
