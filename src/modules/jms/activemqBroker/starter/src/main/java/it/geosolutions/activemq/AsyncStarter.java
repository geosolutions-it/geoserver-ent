...
@ManagedResource(objectName = "bean:name=AsyncStarter", description = "JMX AsyncStarter to start/monitor/dispose ActiveMQ broker", log = true, logFile = "jmx.log", persistName = "AsyncStarter")
public class AsyncStarter implements AsyncServiceMonitor, ServiceMonitor{
    ...
    @Override
    @org.springframework.jmx.export.annotation.ManagedAttribute(description = "async start")
    ...
    @Override
    @org.springframework.jmx.export.annotation.ManagedAttribute(description = "async stop")
